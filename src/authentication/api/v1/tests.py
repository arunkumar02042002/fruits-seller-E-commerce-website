...
class EmailValidatorApiViewTests(APITestCase):
    ...
    def test_duplicate_email(self):
        ...
        self.assertEqual(data['message'], "email: An user with that email already exists.")
        self.assertEqual(data['payload']['errors']['email'][0], "An user with that email already exists.")
    ...
    def test_invalid_email_format(self):
        ...
        self.assertEqual(response.data['message'], "email: Enter a valid email address.")
        self.assertEqual(response.data['payload']['errors']['email'][0], "Enter a valid email address.")
    ...
    def test_missing_email(self):
        ...
        self.assertEqual(response.data['payload']['errors']['email'][0], "This field is required.")
...
class PasswordValidatorApiViewTests(APITestCase):
    ...
    def test_invalid_password(self):
        ...
        data = response.json()
        self.assertEqual(data["status"], "error")
        self.assertEqual(data["message"], "password: This password is too short. It must contain at least 8 characters.")
        self.assertEqual(data["payload"]["errors"]["password"][0], "This password is too short. It must contain at least 8 characters.")
    ...
    def test_missing_password(self):
        ...
        self.assertEqual(data['payload']['errors']['password'][0], "This field is required.")
    ...
    def test_common_password(self):
        ...
        self.assertEqual(data['payload']['errors']['password'][0], "This password is too common.")
